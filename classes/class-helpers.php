...
class Helpers
{
    ...
    public static function enqueue_assets( ...$fonts )
    {
        ...
        if (! isset($fonts) ) {
            echo '<script>console.log("ERROR: Bigupweb\JoineryTheme\Helpers:enqueue_assets() FONT ARGS EMPTY")</script>';
            ...
            foreach ( $fonts as $font_name ) {
                ...
                default:
                    echo '<script>console.log("ERROR: BigupWeb\\\JoineryTheme\\\Helpers:enqueue_assets() FONT NOT FOUND: ' . $font_name .  '")</script>';
                    break;
                }
            }
