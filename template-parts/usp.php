...
$tc_usp_1_text = $tc_settings['tc_usp_1_text'];
$tc_usp_1_url  = $tc_settings['tc_usp_1_url'];
$tc_usp_1_icon = $tc_settings['tc_usp_1_icon'];
$tc_usp_2_text = $tc_settings['tc_usp_2_text'];
$tc_usp_2_url  = $tc_settings['tc_usp_2_url'];
$tc_usp_2_icon = $tc_settings['tc_usp_2_icon'];
$tc_usp_3_text = $tc_settings['tc_usp_3_text'];
$tc_usp_3_url  = $tc_settings['tc_usp_3_url'];
$tc_usp_3_icon = $tc_settings['tc_usp_3_icon'];
$tc_usp_4_text = $tc_settings['tc_usp_4_text'];
$tc_usp_4_url  = $tc_settings['tc_usp_4_url'];
$tc_usp_4_icon = $tc_settings['tc_usp_4_icon'];
