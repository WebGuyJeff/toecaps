...
class Dev_Info {
    ...
    public static function print() {
        ...
        if (is_home()) {echo '<!--is_home:true-->';}else{echo'<!--is_home:false-->';}
        if (is_archive()) {echo '<!--is_archive:true-->';}else{echo'<!--is_archive:false-->';}
        if (is_singular()) {echo '<!--is_singular:true-->';}else{echo'<!--is_singular:false-->';}
    }
