...
module.exports = {
	// Project Identity
	appName: 'joineryTheme', // Unique name of your project
	type: 'theme', // Plugin or theme
	slug: 'joinery-theme', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
	// Used to generate banners on top of compiled stuff
	bannerConfig: {
		name: 'joineryTheme',
		author: 'Jefferson Real <me@jeffersonreal.uk>',
		license: 'GPL-3.0-or-later',
		link: 'GPL-3.0-or-later',
		version: pkg.version,
		copyrightText:
			'This software is released under the GPL-3.0-or-later License\nhttps://opensource.org/licenses/GPL-3.0-or-later',
		credit: true,
	},
