<?php
/**
 * Joinery Theme Functions.php config file.
 *
 ...
 */
use Bigupweb\JoineryTheme\Hooks;
$hooks = new Hooks;
...
function enqueue_scripts_and_styles()
{
    ...
    if (!is_admin() && $GLOBALS['pagenow'] != 'wp-login.php') {
        wp_register_style('category_css', get_template_directory_uri() . '/css/category-css.css', array( 'hb_css' ), filemtime(get_template_directory() . '/css/category-css.css'), 'all');
 ...
 */
function joinery_theme_widgets_init()
{
    register_sidebar(
        array(
        'name'            => esc_html__('Left Sidebar', 'joinery-theme'),
        'id'            => 'sidebar-left',
        'description'   => esc_html__('Used for article contents and includes right sidebar content at mid-width.', 'joinery-theme'),
    ...
    register_sidebar(
        array(
        'name'            => esc_html__('Right Sidebar', 'joinery-theme'),
        'id'            => 'sidebar-right',
        'description'   => esc_html__('Used for related content and unimportant stuff.', 'joinery-theme'),
        'before_widget' => '<section id="%1$s" class="sauce widget %2$s">',
        'after_widget'  => '</section>',
        'before_title'  => '<h3 class="widget_title">',
        'after_title'   => '</h3>',
...
add_action('widgets_init', 'joinery_theme_widgets_init');


if (! function_exists('joinery_theme_setup') ) :
    /**
     ...
     */
    function joinery_theme_setup()
    {
        /*
        * Make theme available for translation.
        * Translations to be filed in the /languages/ directory.
        */
        load_theme_textdomain('joinery-theme', get_template_directory() . '/languages');
        ...
        */
        ...
        register_nav_menus(
            array(
            'mobile-popup-menu'             => esc_html__('Mobile Popup Menu', 'joinery-theme'),
            'global-primary-menu'             => esc_html__('Global Header Menu', 'joinery-theme'),
            'global-secondary-menu'         => esc_html__('Global Footer Menu', 'joinery-theme'),
            'global-legal-links'             => esc_html__('Global Legal Links', 'joinery-theme'),
            'landing-page-primary-menu'     => esc_html__('Landing Page Header Menu', 'joinery-theme'),
            'landing-page-secondary-menu'    => esc_html__('Landing Page Footer Menu', 'joinery-theme'),
            )
        );
...
add_action('after_setup_theme', 'joinery_theme_setup');
...
// ================================================== Joinery Theme admin settings


/**
 * Add Joinery Theme admin menu option to sidebar
 */
function theme_settings_add_menu()
{
    ...
    add_menu_page(
        'Joinery Theme Settings',    //page_title
        'Joinery Theme',            //menu_title
        'manage_options',            //capability
        'joinery-theme-settings',    //menu_slug
        '',                            //function
        $hb__icon,                    //icon_url
        4                            //position
    );
    ...
    add_submenu_page(
        'joinery-theme-settings',    //parent_slug
        'Joinery Theme Settings',    //page_title
...
/**
 * Create Joinery Theme Global Settings Page
 */
